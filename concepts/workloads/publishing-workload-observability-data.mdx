---
title: "Publishing Workload Observability Data"
---
...
The information required to communicate with the device's OTEL Collector is injected into each container using [environment variables](../edge-compute-devices/collecting-workload-observability-data.mdx#connecting-to-the-opentelemetry-collector).
...
> **Note:** See the [workload observability overview](../../overview/workload-observability-overview.mdx) page for more information about workload observablity.
>
