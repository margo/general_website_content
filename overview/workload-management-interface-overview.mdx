---
title: "Workload Fleet Management"
---
...
Fleet management within Margo follows a state seeking model utilizing local device providers to complete the orchestration defined via the desired state. See [Fleet Management concepts](../personas-definitions/technical-lexicon.mdx#concepts) for further details. 
...
- [Margo API Technical Reference](../margo-api-reference/margo-management-interface/api-req-security-details.mdx)
