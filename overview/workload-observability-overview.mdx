...
- How workload suppliers can [publish observability data](../concepts/workloads/publishing-workload-observability-data.mdx)
- How devices must [collection workload observability data](../concepts/edge-compute-devices/collecting-workload-observability-data.mdx)
- How workload fleet management solutions can [consume workload observability data](../concepts/workload-fleet-managers/consuming-workload-observability-data.mdx)
