...
[Applications](./technical-lexicon#application) can be found in completely different stages:
...
This section does not declare terminology, that is the task of the [Technical Lexicon](technical-lexicon.mdx), but rather tries to scope some of the terms to the above mentioned stages.
...
[application-registry]: technical-lexicon.mdx#application-registry
[component]: technical-lexicon.mdx#component
[workload]: technical-lexicon.mdx#workload
[application]: technical-lexicon.mdx#application
[component-registry]: technical-lexicon.mdx#component-registry
[deployment-definition]: ../margo-api-reference/margo-management-interface/desired-state.mdx#applicationdeployment-definition
[provider-model]: technical-lexicon.mdx#provider-model
[wfma]: technical-lexicon.mdx#workload-fleet-management-agent
[deployment-profile]: ../margo-api-reference/application-package/application-description.mdx#deploymentprofile-attributes
