...
These identities are the only names that carry trust. Operational labels such as the [Target Name](../../personas-and-definitions/technical-lexicon.md#target-name) given to Target Compute exist to help people recognize what they are deploying to, and are never used to authenticate a component or grant it access.
